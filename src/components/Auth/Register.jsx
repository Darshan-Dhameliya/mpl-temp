...
import BeautifulDatePicker from "./DatePicker";
                  ...
                  <div className="w-1/2 pe-4">
                    <div className="my-4">
                      ...
                      <div className="flex flex-col gap-3 pe-10">
                        <div className="self-end text-white">step 1/2</div>
                        ...
                        <div>
                          ...
                          <spa className="text-[#626778] ml-3 mt-1 block text-sm">
                        ...
                        <TextField placeholder="Code (optional)" />
                        <div class="flex items-center">
                          ...
                          <label for="agree" class="ml-2 text-red-700 text-sm">
                            I agree I agree to the con rm I am at least years
                            old
                          </label>
                        </div>
                        <div class="flex items-center ">
                          ...
                          />
                          <label for="agree" class="ml-2 text-white text-sm">
                            I agree I agree to the con rm I am at least years
                            old
                          </label>
                        </div>
